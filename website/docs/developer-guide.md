...
Готовые фрагменты для DI, тиков, событий, жизненного цикла и команд собраны в
разделе [Примеры](examples.md). Публичные контракты см. в общей
[сгенерированной документации API](api-reference.md) на английском языке.
