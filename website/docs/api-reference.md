...
Это общая техническая справка: она публикуется в одном, английском языке для обеих локалей. Откройте <a href="/Asssets/api/index.html" data-noBrokenLinkCheck>сгенерированный API KofeyekToolkit</a>, чтобы просмотреть пространства имён, типы, члены и XML-документацию.
